...
complete -c shelly -n __fish_use_subcommand -a remove-corruption -d "Find and remove corrupted packages"
...
# --- remove-corruption (CorruptedPackagesSettings) ---
complete -c shelly -n "__fish_seen_subcommand_from remove-corruption" -s n -l no-confirm -d "Skip confirmation prompts"
complete -c shelly -n "__fish_seen_subcommand_from remove-corruption" -s d -l dry-run -d "Show what would be removed without removing"
